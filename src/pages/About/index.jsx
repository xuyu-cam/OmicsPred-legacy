...
const About = () => {
  return (
    <div className="pl-[5%] w-[90%] pt-[70px]">
      <Container
        title="About"
        text="The Omics Atlas development was led by Yu Xu, under the supervison of Michael Inouye at the Department of Public Health and Primary Care, University of Cambridge."
      />
      <Container
      title="Our Collaborators"
        text="InouyeLab: Scott Ritchie, Sam Lambert, Loïc Lannelongue, Artika Nath, Elodie Persyn
